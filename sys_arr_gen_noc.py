...
file_path = "C:/Users/Admin/Documents/Adhithyan/NxN/sources/noc_nxn_sys_1.v"
file = open(file_path, "w")

noc_size=int(input("enter the size of network : "))
bit = int(input("Bit Size: "))-1
sys_array=int(input("enter the size of systolic array : "))
...
for k in range (sys_array):
        for i in range (noc_size):
            for j in range (noc_size): 
               file.write("\t input ["+str(bit)+":0] inp_w")
               file.write(str(k)+"_")
               file.write(str(i)+str(j)+",\n")
...
for k in range (sys_array):
        for i in range (noc_size):
            for j in range (noc_size): 
               file.write("\t input ["+str(bit)+":0] inp_n")
               file.write(str(k)+"_")
               file.write(str(i)+str(j)+",\n")
...
for k in range (sys_array):
    for l in range (sys_array):
        for i in range (noc_size):
            for j in range (noc_size): 
               file.write("\t wire ["+str(bit)+":0] result_")
               file.write(str(k)+str(l)+"_out")
               file.write(str(i)+str(j)+";\n")
...
for i in range (noc_size):
    for j in range (noc_size):
        file.write("\twire [BUS_WIDTH-"+str(2*addr_width)+":0] sum_")
        file.write(str(i)+str(j)+";\n")
...
file_path2 = "C:/Users/Admin/Documents/Adhithyan/NxN/sim/noc_nxn_tb_sys_1.v"
...
for k in range (sys_array):
        for i in range (noc_size):
            for j in range (noc_size): 
               testbench.write("\t reg ["+str(bit)+":0] inp_w")
               testbench.write(str(k)+"_")
               testbench.write(str(i)+str(j)+";\n")

for k in range (sys_array):
        for i in range (noc_size):
            for j in range (noc_size): 
               testbench.write("\t reg ["+str(bit)+":0] inp_n")
               testbench.write(str(k)+"_")
               testbench.write(str(i)+str(j)+";\n")
...
for k in range (sys_array):
    for l in range (sys_array):
        for i in range (noc_size):
            for j in range (noc_size): 
               testbench.write("\t wire ["+str(bit)+":0] result_")
               testbench.write(str(k)+str(l)+"_out")
               testbench.write(str(i)+str(j)+";\n")
...
for k in range (sys_array):
    for i in range (noc_size):
        for j in range (noc_size):
             testbench.write("\t.inp_n")
             testbench.write(str(k)+"_")
             testbench.write(str(i)+str(j)+"(")
             testbench.write("inp_n")
             testbench.write(str(k)+"_")
             testbench.write(str(i)+str(j)+")")
             if(i==(noc_size-1) and j==(noc_size-1) and k==(sys_array-1)):
                 testbench.write("\n")
             else:
                 testbench.write(",\n")
testbench.write(");\n\n")
...
file_path3 = "C:/Users/Admin/Documents/Adhithyan/NxN/sim/noc_nxn_tb2_sys_1.v"
...
for k in range (sys_array):
        for i in range (noc_size):
            for j in range (noc_size): 
               testbench1.write("\t reg ["+str(bit)+":0] inp_w")
               testbench1.write(str(k)+"_")
               testbench1.write(str(i)+str(j)+";\n")

for k in range (sys_array):
        for i in range (noc_size):
            for j in range (noc_size): 
               testbench1.write("\t reg ["+str(bit)+":0] inp_n")
               testbench1.write(str(k)+"_")
               testbench1.write(str(i)+str(j)+";\n")
...
for k in range (sys_array):
    for l in range (sys_array):
        for i in range (noc_size):
            for j in range (noc_size): 
               testbench1.write("\t wire ["+str(bit)+":0] result_")
               testbench1.write(str(k)+str(l)+"_out")
               testbench1.write(str(i)+str(j)+";\n")
...
file_path3 = "C:/Users/Admin/Documents/Adhithyan/NxN/sources/adder.v"
adder = open(file_path3, "w")

adder.write("`timescale 1ns / 1ps\n")
adder.write("////////////////////////////////////////////////////////////\n")
adder.write("module adder # (parameter BUS_WIDTH = 32)\n")
adder.write("(\n")



for i in range (sys_array):
    for j in range (sys_array):
        adder.write("\tinput ["+ str((bit)) + ":0] num_")
        adder.write(str(i)+str(j)+",\n")
adder.write("\tinput clk,\n")
adder.write("\toutput reg [BUS_WIDTH-6:0] sum\n" )
adder.write(");\n")
adder.write("\n")
adder.write("reg [BUS_WIDTH-5:0] temp_sum;\n")

adder.write("\talways @(posedge clk) begin\n")
adder.write("\t\ttemp_sum = ")
for i in range (noc_size):
    for j in range (noc_size):
        adder.write("\tnum_")
        adder.write(str(i)+str(j))
...
adder.write("\t\tsum = temp_sum;\n")
adder.write("\tend\n")
adder.write("\n")
adder.write("endmodule")
