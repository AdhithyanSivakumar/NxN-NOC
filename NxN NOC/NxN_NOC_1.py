...
file_path = "C:/Users/Admin/Documents/NxN_noc_multiplier_1/sources/noc_nxn_edited.v"
...
for i in range (noc_size):
    for j in range (noc_size):
        file.write("\tinput [7:0] A")
        file.write(str(i)+str(j)+",\n")
        file.write("\tinput [7:0] B")
        file.write(str(i)+str(j)+",\n")
...
for i in range (noc_size):
    for j in range (noc_size):
        file.write("\twire [BUS_WIDTH-5:0] z")
        file.write(str(i)+str(j)+";\n")


for i in range (noc_size):
    for j in range (noc_size):
        file.write("\tmultiplier m")
        file.write(str(i)+str(j))
        file.write("\t (A")
        file.write(str(i)+str(j))
        file.write("\t , B")
        file.write(str(i)+str(j))
        file.write("\t , router_in")
        file.write(str(i)+str(j))
        file.write("\t , clk1);"+"\n")
...
file_path2 = "C:/Users/Admin/Documents/NxN_noc_multiplier_1/sim/noc_nxn_tb_edited.v"
...
for i in range (noc_size):
    for j in range (noc_size):
        testbench.write("\treg [7:0] A")
        testbench.write(str(i)+str(j)+";\n")
        testbench.write("\treg [7:0] B")
        testbench.write(str(i)+str(j)+";\n")
...
# A00 --> B22 initialisation ==> check if required
...
for i in range (noc_size):
    for j in range(noc_size):
        ...
        testbench.write("\t\t\t\tA"+str(i)+str(j)+"= 8'h0;\n\t")
        testbench.write("\t\t\t\tB"+str(i)+str(j)+"= 8'h0;\n\t")
...
for i in range (noc_size):
    for j in range(noc_size):
        testbench.write("\t\t\tif(!buffer_out"+str(i)+str(j)+")\n\t")
        testbench.write("\t\t\t\tA"+str(i)+str(j)+"=$random;\n\t")
        testbench.write("\t\t\t\tB"+str(i)+str(j)+"= $random;\n\t")
...
file_path3 = "C:/Users/Admin/Documents/NxN_noc_multiplier_1/sim/noc_nxn_tb2_edited.v"
...
for i in range (noc_size):
    for j in range (noc_size):
        testbench1.write("\treg [7:0] A")
        testbench1.write(str(i)+str(j)+";\n")
        testbench1.write("\treg [7:0] B")
        testbench1.write(str(i)+str(j)+";\n")
...
# Check if the A00 --> B22 initialisation is required ?
...
for i in range (noc_size):
    for j in range(noc_size):
        ...
        testbench1.write("\t\t\t\tA"+str(i)+str(j)+"= 8'h0;\n\t")
        testbench1.write("\t\t\t\tB"+str(i)+str(j)+"= 8'h0;\n\t")
...
for i in range (noc_size):
    for j in range(noc_size):
        ...
        testbench1.write("\t\t\t\tA"+str(i)+str(j)+"= $random;\n\t")
        testbench1.write("\t\t\t\tB"+str(i)+str(j)+"= $random;\n\t")
